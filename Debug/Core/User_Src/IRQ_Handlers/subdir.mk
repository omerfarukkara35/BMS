...
C_SRCS += \
../Core/User_Src/IRQ_Handlers/can_irq_config.c \
../Core/User_Src/IRQ_Handlers/timer3_irq_config.c 

OBJS += \
./Core/User_Src/IRQ_Handlers/can_irq_config.o \
./Core/User_Src/IRQ_Handlers/timer3_irq_config.o 

C_DEPS += \
./Core/User_Src/IRQ_Handlers/can_irq_config.d \
./Core/User_Src/IRQ_Handlers/timer3_irq_config.d 


# Each subdirectory must supply rules for building sources it contributes
Core/User_Src/IRQ_Handlers/%.o: ../Core/User_Src/IRQ_Handlers/%.c
	@echo 'Building file: $<'
